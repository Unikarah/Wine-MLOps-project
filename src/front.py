...
st.markdown('The API is hosted on Heroku and the code is available on Github [here](git@github.com:Unikarah/MLOPS.git)')
...
def retrain_data():
    uploaded_file = st.file_uploader("Choose a CSV with the new wine data", type="csv")
